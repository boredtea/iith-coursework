...
#define MAX_EDGES 3000  //the maximum number of neighbours a person can have
#define Tau 0.5
#define Gamma 0.2
...
void main()
{
    ...
    while (heapSize > 1)
    {
        ...
        else if (current.status == 'T')
        {
            ...
            if (people[current.neighbour_ID].status == 'S')
            {
                //S--;
                //I++;
